...
class CompetitionToolStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Name = channel.unary_unary(
                ...
                response_deserializer=competition__pb2.NameReply.FromString,
                _registered_method=True)
        self.Initialize = channel.stream_unary(
                '/CompetitionTool/Initialize',
                request_serializer=competition__pb2.Oracle.SerializeToString,
                response_deserializer=competition__pb2.InitializationReply.FromString,
                _registered_method=True)
...
def add_CompetitionToolServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Name': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=competition__pb2.NameReply.SerializeToString,
            ),
            'Initialize': grpc.stream_unary_rpc_method_handler(
                    servicer.Initialize,
                    request_deserializer=competition__pb2.Oracle.FromString,
                    response_serializer=competition__pb2.InitializationReply.SerializeToString,
            ),
...
class CompetitionTool(object):
    ...
    def Name(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            competition__pb2.NameReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Initialize(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/CompetitionTool/Initialize',
            competition__pb2.Oracle.SerializeToString,
            competition__pb2.InitializationReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
